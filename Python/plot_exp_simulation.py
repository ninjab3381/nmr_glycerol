...
if __name__ == "__main__":
    ...
    ppm_list1, rel_intensity_list1 = read_file("../Temp_213K/Experiment/213k.csv")
    plot_line(ppm_list1, rel_intensity_list1, "green", "dashed", "Experiment")
    ppm_list2, rel_intensity_list2 = read_file("../GAUSS/jump_freq_800/Simulation_Spectra_Avg/800Hz_simulation_05sigma_lognormal_for_plotting.csv")
