...
if __name__ == "__main__":
    ...
    ppm_list1, rel_intensity_list1 = read_file("../Temp_238K/Experiment/238k.csv")
    plot_line(ppm_list1, rel_intensity_list1, "green", "dashed", "Experiment")
    ppm_list2, rel_intensity_list2 = read_file("../Temp_238K/Simulation_Spectra_Avg/LogNormal/T2_004/238k_simulation_10sigma_lognormal_for_plotting.csv")
