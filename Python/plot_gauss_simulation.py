...
if __name__ == "__main__":
    ...
    ppm_list2, rel_intensity_list2 = read_file("../GAUSS_SKEWED/jump_freq_1200/Simulation_Spectra_Avg/1200Hz_simulation_15sigma_lognormal_skewed1_for_plotting.csv")
    fig, ax = plt.subplots()
