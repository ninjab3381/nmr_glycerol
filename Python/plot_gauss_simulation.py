...
if __name__ == "__main__":
    ...
    ppm_list2, rel_intensity_list2 = read_file("../GAUSS_SKEWED/jump_freq_800/Simulation_Spectra_Avg/800Hz_simulation_15sigma_lognormal_skewed-test1-for-plotting.csv")
    fig, ax = plt.subplots()
